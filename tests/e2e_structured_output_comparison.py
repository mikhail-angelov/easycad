...
from scripts.compare_structured_outputs import SCHEMA, request
...
class StructuredOutputComparisonE2E(unittest.TestCase):
    ...
    def test_1_deepseek_strict_tool_writes_result(self):
        payload = {"model": os.environ.get("DEEP_SEEK_MODEL", "deepseek-chat"), "messages": self.messages, "tools": [{"type": "function", "function": {"name": "submit_draft_specification", "description": "Return the draft specification.", "parameters": SCHEMA, "strict": True}}], "tool_choice": {"type": "function", "function": {"name": "submit_draft_specification"}}}
