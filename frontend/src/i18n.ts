...
const STRINGS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'chat.stageRefining': 'Refining your request…',
    'chat.stageGenerating': 'Generating geometry…',
    'chat.stageBuilding': 'Building the model…',
    'chat.stageRepairing': 'Repairing generated code…',
    ...
    'auth.tokenError': 'That access token was invalid or expired. You can keep using the free trial, or sign in.',
    'account.tokensTitle': 'Access tokens',
    'account.tokensHint': 'Long-lived tokens (30 days) for automation / API agents. The secret is shown once.',
    'account.tokenNamePlaceholder': 'Token name (e.g. playwright-ci)',
    'account.tokenCreate': 'Create token',
    'account.tokenCopy': 'Copy',
    'account.tokenCopied': 'Copied',
    'account.tokenValueHint': 'Copy this now — it will not be shown again.',
    'account.tokenRevoke': 'Revoke',
    'account.tokenRevoked': 'revoked',
    'account.tokenExpired': 'expired',
    'account.tokenOpError': 'Could not complete that token operation. Try again.',
  },
  ru: {
    ...
    'chat.stageRefining': 'Уточняю запрос…',
    'chat.stageGenerating': 'Генерирую геометрию…',
    'chat.stageBuilding': 'Собираю модель…',
    'chat.stageRepairing': 'Исправляю сгенерированный код…',
    ...
    'auth.tokenError': 'Токен доступа недействителен или истёк. Можно продолжить с бесплатным доступом или войти.',
    'account.tokensTitle': 'Токены доступа',
    'account.tokensHint': 'Долгоживущие токены (30 дней) для автоматизации / агентов. Секрет показывается один раз.',
    'account.tokenNamePlaceholder': 'Название токена (напр. playwright-ci)',
    'account.tokenCreate': 'Создать токен',
    'account.tokenCopy': 'Копировать',
    'account.tokenCopied': 'Скопировано',
    'account.tokenValueHint': 'Скопируйте сейчас — он больше не будет показан.',
    'account.tokenRevoke': 'Отозвать',
    'account.tokenRevoked': 'отозван',
    'account.tokenExpired': 'истёк',
    'account.tokenOpError': 'Не удалось выполнить операцию с токеном. Попробуйте снова.',
  },
}
